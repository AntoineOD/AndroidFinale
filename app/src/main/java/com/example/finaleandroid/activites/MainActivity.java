...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Modele modele = ModeleManager.getInstance();

        PrensentateurCode prensentateurCode = new PrensentateurCode(this);
        prensentateurCode.ObtenirCode();
        List<Code> listCodes = prensentateurCode.getCodes();
        Code codeSecret = prensentateurCode.obtenirCodeSecret(longueurCode, nbCouleurs);
